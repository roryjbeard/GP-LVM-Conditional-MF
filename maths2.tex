...
&= \Ex_{q(\ub,X_z)}\left[\sum_{q=1}^Q \tr(\Lb) + \zb_q^\top\zb - B -  \log\det\Lb \right] \\
&= \Ex_{q(\ub,X_z)}\left[\sum_{q=1}^Q \tr(\Lb) + \ub_q^\top\Ab^\top\Ab\ub_q - B -  \log\det\Lb \right] \\
&=\Ex_{q(X_z)}\left[\sum_{q=1}^Q \tr(\Lb) + \Ex_{q(\ub_z)}[\tr(\Ab^\top\Ab\ub_q\ub_q^\top)] - B -  \log\det\Lb \right] \\
&=\Ex_{q(X_z)}\left[\sum_{q=1}^Q \tr(\Lb) + \tr(\Ab^\top\Ab\kappa_q\kappa_q^\top) + \tr(\Ab^\top\Ab\Kappa) - B -  \log\det\Lb \right]
\end{align}
%
