...
l_enc_h1_mu_s = lasagne.layers.DenseLayer(l_enc_h1, num_units=latent_ext_size, nonlinearity=lasagne.nonlinearities.identity, name='ENC_S_MU')
...
l_enc_s = SimpleSampleLayer(mean=l_enc_h1_mu_s, log_var=l_enc_log_var_s)
...
s_aux_mu_train, s_aux_log_var_train, s_aux_train, x_mu_train = lasagne.layers.get_output(
                                        [l_enc_h1_mu_s, l_enc_log_var_s, l_enc_s,
