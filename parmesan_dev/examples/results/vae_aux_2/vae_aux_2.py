...
l_enc_h1_from_x = lasagne.layers.DenseLayer(l_in, num_units=nhidden, nonlinearity=nonlin_enc, name='ENC_FROM_X_DENSE1')
l_enc_h1_from_x = lasagne.layers.DenseLayer(l_enc_h1_from_x, num_units=nhidden, nonlinearity=nonlin_enc, name='ENC_FROM_X_DENSE2')

l_enc_mu_s = lasagne.layers.DenseLayer(l_enc_h1_from_x, num_units=latent_ext_size, nonlinearity=lasagne.nonlinearities.identity, name='ENC_S_MU')
l_enc_log_var_s = lasagne.layers.DenseLayer(l_enc_h1_from_x, num_units=latent_ext_size, nonlinearity=lasagne.nonlinearities.identity, name='ENC_S_LOG_VAR')
...
l_enc_h1_from_s = lasagne.layers.DenseLayer(l_enc_s, num_units=nhidden, nonlinearity=nonlin_enc, name='ENC_FROM_S_DENSE1')
l_enc_h1_from_s = lasagne.layers.DenseLayer(l_enc_h1_from_s, num_units=nhidden, nonlinearity=nonlin_enc, name='ENC_FROM_S_DENSE2')

#add the activations from the two origins to give the input to z
l_enc_h_from_s_and_x = lasagne.layers.ElemwiseSumLayer([l_enc_h1_from_x, l_enc_h1_from_s])

l_enc_mu_z = lasagne.layers.DenseLayer(l_enc_h_from_s_and_x, num_units=latent_ext_size, nonlinearity=lasagne.nonlinearities.identity, name='ENC_Z_MU')
l_enc_log_var_z = lasagne.layers.DenseLayer(l_enc_h_from_s_and_x, num_units=latent_ext_size, nonlinearity=lasagne.nonlinearities.identity, name='ENC_Z_LOG_VAR')
...
l_aux_h1_from_x = lasagne.layers.DenseLayer(l_in,
                                num_units=nhidden,
                                nonlinearity=nonlin_aux,
                                name='AUX_FROM_X_DENSE1')
l_aux_h1_from_x = lasagne.layers.DenseLayer(l_aux_h1_from_x,
                                num_units=nhidden,
                                nonlinearity=nonlin_aux,
                                name='AUX_FROM_X_DENSE2')

l_aux_h1_from_z = lasagne.layers.DenseLayer(l_z,
                                num_units=nhidden,
                                nonlinearity=nonlin_aux,
                                name='AUX_FROM_Z_DENSE1')
l_aux_h1_from_z = lasagne.layers.DenseLayer(l_z,
                                num_units=nhidden,
                                nonlinearity=nonlin_aux,
                                name='AUX_FROM_Z_DENSE2')

#add the activations from the two origins to give the input to s
l_aux_h_from_z_and_x = lasagne.layers.ElemwiseSumLayer([l_aux_h1_from_x, l_aux_h1_from_z])

l_aux_mu = lasagne.layers.DenseLayer(l_aux_h_from_z_and_x,
                                num_units=latent_ext_size,
                                nonlinearity=lasagne.nonlinearities.identity,
                                name='AUX_MU')
l_aux_log_var = lasagne.layers.DenseLayer(l_aux_h_from_z_and_x,
                                num_units=latent_ext_size,
                                nonlinearity=lasagne.nonlinearities.identity,
                                name='AUX_DENSE2')
